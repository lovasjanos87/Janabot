...
class EncoderVals(metaclass=Metaclass_EncoderVals):
    ...
    def __init__(self, **kwargs):
        ...
        self.mot_1_enc_val = kwargs.get('mot_1_enc_val', float())
    ...
    def mot_1_enc_val(self, value):
        if __debug__:
            assert \
                ...
                "The 'mot_1_enc_val' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'mot_1_enc_val' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
