...
static rosidl_typesupport_introspection_c__MessageMember serial_motor_demo_msgs__msg__EncoderVals__rosidl_typesupport_introspection_c__EncoderVals_message_member_array[1] = {
  {
    "mot_1_enc_val",  // name
