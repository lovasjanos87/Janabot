...
class MotorDriver(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(MotorCommand,'motor_command',self.motor_command_callback,10)
    ...
    def check_encoders(self):
        ...
        if (resp):
          ...
          # self.speed_pub.publish(spd_msg)
            ...
            enc_msg = EncoderVals()
            enc_msg.mot_1_enc_val = float(value)
